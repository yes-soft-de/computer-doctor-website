...
<div class="social-media">
    <div class="container">
        <div class="col-md-8 mx-auto text-center">
            <div class="row">
                <a href="#" class="col d-flex social mb-2 facebook"><i class="fab fa-facebook-square fa-lg p-2"></i>facebook</a>
                <a href="#" class="col d-flex social mb-2 instagram"><i class="fab fa-instagram fa-lg p-2"></i>instagram</a>
                <a href="#" class="col d-flex social mb-2 twitter"><i class="fab fa-twitter fa-lg p-2"></i>twitter</a>
                <a href="#" class="col d-flex social mb-2 linkedin"><i
